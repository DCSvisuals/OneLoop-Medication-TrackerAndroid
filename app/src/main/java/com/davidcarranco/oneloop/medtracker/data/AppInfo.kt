...
object AppInfo {
    const val APP_NAME = "OneLoop UIv2"
...
OneLoop UIv2 is a personal organization and reminder app. It is intended only to help you track medication schedules you enter yourself.

OneLoop UIv2 is not a medical device. It does not provide medical advice, diagnosis, or treatment, and it does not replace guidance from a licensed healthcare professional, pharmacist, or the instructions on your medication label.
...
Reminder notifications depend on your device settings, power state, and system permissions. OneLoop UIv2 cannot guarantee that every reminder will be delivered or seen. You remain responsible for taking your medications as prescribed.

Account and cloud backup: If you create an account or sign in (for example with email or Google), OneLoop UIv2 may store your account information and any medication data you choose to upload on Supabase (a cloud database and authentication service). Cloud backup is optional. Data kept only on this device is not sent to Supabase until you sign in and upload.
...
3. Notifications
If you enable medication reminders, OneLoop UIv2 schedules local notifications on your device. Notification permission is optional and can be changed in Android Settings.

4. Analytics and advertising
This version of OneLoop UIv2 does not include third-party advertising SDKs or analytics SDKs that track you across apps and websites.
